...
const findRemeinder = (num1, num2) => {
    // La funccion recibe 2 numeros . PRIMERO: devemos averiguar cual es el divisor y el dividendo, 
    ...
    // en caso de que el divisor sea un 0 retornar el mensaje "No es posible dividr por 0"
    // tu codigo AQUI:
}
